  ...
  return (
    <div className="flex flex-col gap-10 m-1">
      <header className="flex flex-col gap-3 bg-blue-200 rounded-lg p-4">
        ...
        <div className="flex justify-center">
        <button onClick={handleNavigate} className='bg-blue-700 text-white p-2 m-2 rounded font-semibold hover:bg-blue-800 hover:font-bold transition-all'>Get Started</button>
        </div>
      </header>
